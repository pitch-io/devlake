...
type Connection struct {
	...
	ApiKey           string `mapstructure:"apiKey" env:"DATADOG_API_KEY" validate:"required" encrypt:"yes"`
	ApplicationKey   string `mapstructure:"applicationKey" env:"DATADOG_APPLICATION_KEY" validate:"required" encrypt:"yes"`
}
