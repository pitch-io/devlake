...
func extractIncident(rawData []byte, data *DatadogTaskData) ([]interface{}, errors.Error) {
	...
	incident := &models.Incident{
		...
		Slug:                   firstFieldValue(attributes.Fields, "slug"),
		...
		IsTest:                 false,
		Visibility:             derefString(attributes.Visibility),
		...
		CustomerImpactDuration: attributes.CustomerImpactDuration,
		TimeToDetect:           attributes.TimeToDetect,
		TimeToInternalResponse: attributes.TimeToInternalResponse,
