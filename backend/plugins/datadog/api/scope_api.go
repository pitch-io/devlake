...
type ScopeDetail api.ScopeDetail[models.IncidentType, models.DatadogScopeConfig]

// PutScopes create or update datadog incident type
// @Summary create or update datadog incident type
// @Description Create or update datadog incident type
...
// @Router /plugins/datadog/connections/{connectionId}/scopes [PUT]
func PutScopes(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	return dsHelper.ScopeApi.PutMultiple(input)
}

// PatchScope patch to datadog incident type
// @Summary patch to datadog incident type
// @Description patch to datadog incident type
// @Tags plugins/datadog
// @Accept application/json
// @Param connectionId path int true "connection ID"
...
// @Failure 400  {object} shared.ApiBody "Bad Request"
// @Failure 500  {object} shared.ApiBody "Internal Error"
// @Router /plugins/datadog/connections/{connectionId}/scopes/{scopeId} [PATCH]
func PatchScope(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	return dsHelper.ScopeApi.Patch(input)
}

// GetScopeList get datadog incident types
// @Summary get datadog incident types
// @Description get datadog incident types
// @Tags plugins/datadog
// @Param connectionId path int true "connection ID"
...
// @Failure 400  {object} shared.ApiBody "Bad Request"
// @Failure 500  {object} shared.ApiBody "Internal Error"
// @Router /plugins/datadog/connections/{connectionId}/scopes/ [GET]
func GetScopeList(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	return dsHelper.ScopeApi.GetPage(input)
}

// GetScope get one datadog incident type
// @Summary get one datadog incident type
// @Description get one datadog incident type
// @Tags plugins/datadog
// @Param connectionId path int true "connection ID"
// @Param scopeId path string true "scope ID"
...
// @Failure 400  {object} shared.ApiBody "Bad Request"
// @Failure 500  {object} shared.ApiBody "Internal Error"
// @Router /plugins/datadog/connections/{connectionId}/scopes/{scopeId} [GET]
...
// @Failure 500  {object} shared.ApiBody "Internal Error"
// @Router /plugins/datadog/connections/{connectionId}/scopes/{scopeId} [DELETE]
